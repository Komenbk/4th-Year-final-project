...
$sql=mysql_query("Update users set fullName='$fname',address='$address',city='$city',gender='$gender' where phone='".$_SESSION['login']."'");
if($sql)
{
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<?php $sql=mysql_query("select * from users where phone='".$_SESSION['login']."'");
...
<div class="form-group">
					...
					<input type="email" name="uemail" class="form-control"  readonly="readonly"  value="<?php echo htmlentities($data['phone']);?>">
														</div>
